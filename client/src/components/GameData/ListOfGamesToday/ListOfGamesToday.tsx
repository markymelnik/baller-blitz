...
export const ListOfGamesToday = () => {
  ...
  return (
    <>
      {gamesState === 'NOT_STARTED' && <div className="list-message">Games haven't started yet.</div>}
      {gamesState === 'IN_PROGRESS' && <div className="list-message">Games are live.</div>}
      {gamesState === 'FINISHED' && <div className="list-message">Games are finished.</div>}
